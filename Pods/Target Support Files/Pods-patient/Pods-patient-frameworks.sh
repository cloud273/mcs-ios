...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CLLocalization/CLLocalization.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/QDCore/QDCore.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/QDWhiteLabel/QDWhiteLabel.framework"
fi
